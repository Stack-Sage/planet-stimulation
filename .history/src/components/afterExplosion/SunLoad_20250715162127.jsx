...
const SunLoad = () => {
  ...
  useEffect(() => {
    const timeout1 = setTimeout(() => {
      ...
      // ✅ Move toastMsg here (not inside JSX)
      toastMsg("A wild comet appears! ☄️", {
        background: "linear-gradient(to right, #0f2027, #203a43, #2c5364)", // galaxy dark
        color: "white",
      });
    }, 1000);
  ...
  return (
    <div className="relative z-10 min-w-screen min-h-screen w-full h-full flex items-center bg-black justify-center">
      <div className="w-full mx-auto">
        {/* This just reserves space for the toaster. No toastMsg calls here. */}
      </div>
