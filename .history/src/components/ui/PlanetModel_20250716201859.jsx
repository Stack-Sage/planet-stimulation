...
const PlanetModel = () => {
  ...
  return (
    <span
      ref={containerRef}
      className="absolute invert md:top-80 lg:top-48 hue-rotate-15 contrast-200 brightness-200 md:left-96  lg:left-[800px]   -translate-x-1/2 -translate-y-1/2 bg-transparent hover:cursor-pointer  z-0 "
