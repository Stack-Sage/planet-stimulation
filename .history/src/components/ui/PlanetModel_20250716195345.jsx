...
const PlanetModel = () => {
  ...
  return (
    <span
      ref={containerRef}
      className="absolute invert hue-rotate-15 contrast-200 brightness-200 left-1/2 top-1/2  -translate-x-1/2 -translate-y-1/2 bg-transparent   z-0 "
    ...
    >
      <Globe
        ...
        showAtmosphere={true}
        atmosphereColor="rgba(0, 150, 0, 0.3)"
