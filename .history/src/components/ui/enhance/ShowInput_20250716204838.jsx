      ...
      {showInput && !hasEnteredName && (
        <div className="mt-3 flex items-center  pb-4 w-fit gap-2">
          <input
            ...
            className="  mt-4 invert hue-rotate-180 bg-gradient-to-tr from-blue-300 via-ini text-center w-fit outline-white border-white border-2 outline-2 ring-2 ring-blue-500  rounded text-white scale "
          >
