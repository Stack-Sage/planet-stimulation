      ...
      {showInput && !hasEnteredName && (
        <div className="mt-3 flex items-center  pb-4 w-fit gap-2">
          <input
            ...
            className="  mt-4 brightness-125 invert -hue-rotate-15  bg-gradient-to-tr from-blue-300 via-in-300 to-blue-200 text-center w-fit  outline-none border-none ring-1 ring-blue-500 font-bold text-black rounded  scale "
          >
