  ...
  return (
    <div className=" ">
      ...
      {showInput && !hasEnteredName && (
        <div className="mt-3 flex items-center w-20  gap-2">
          <input
            ...
            className="  mt-4  text-center w-fit outline-white border-white border-2 outline-2 ring-2 ring-blue-500  rounded text-white scale p-4"
          >
