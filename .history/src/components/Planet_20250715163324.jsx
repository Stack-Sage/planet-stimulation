...
const Planet = () => {
  ...
  const {   nebulaCost, planetDis, setPlanetDis,  setNebulaCost, value, setValue, allowSound, highestLevel } =
  ...
  const timeout1 = setTimeout(() => {
    playSound();
    toastMsg("Yo! A new Star has been formed. Careful, it's quite hot.", {
  ...
  return (
    <>
      <div className=" relative group z-30  ">
        ...
        <button className={`  group hover:shadow-lg object-cover hover:shadow-white border-none ring-1 ring-blue-400 p-2 text-lg px-4 rounded-lg active:text-blue-400  hover:ring-sky-900 animate-slide-in ${buttonStyle} `} >
          <img
            onClick={click}
            src={ig.nebulamodel}
            alt="Nebula"
